...
export const metadata = {
  title: 'Privacy Policy & Terms of Service | BangkokCams',
  description: 'Privacy Policy, YouTube API Services disclosure, cookie governance, and platform compliance terms for BangkokCams.com.',
  openGraph: {
    title: 'Privacy Policy & Terms | BangkokCams.com',
    description: 'Privacy Policy, YouTube API Services disclosure, and platform compliance terms.',
    url: 'https://bangkokcams.com/privacy/',
    type: 'website',
  },
};
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-8 sm:py-12">
        ...
        <div className="border-b border-borderDark pb-6 mb-8">
          ...
          <p className="text-xs sm:text-sm font-mono text-slate-400">
            Effective Date: September 2026 • Platform: BangkokCams.com
          </p>
        </div>
        ...
        <div className="space-y-8 text-sm text-slate-300 leading-relaxed font-normal">
          ...
          <section className="bg-surface border border-borderDark rounded-2xl p-5 sm:p-7 shadow-lg space-y-3">
            ...
            <p>
              BangkokCams uses official YouTube API Services and embedded YouTube and Kick video players to display public broadcasts, 24/7 webcams, and curated 4K street walks.
            </p>
            <p>
              By accessing and viewing YouTube video content on BangkokCams, you acknowledge and agree to be bound by the{' '}
              <a
          ...
          <section className="bg-surface border border-borderDark rounded-2xl p-5 sm:p-7 shadow-lg space-y-3">
            ...
            <p className="text-xs text-slate-400">
              BTS Skytrain, MRT, canal, and river transit timetables are curated navigational approximations for tourist orientation and are not legally binding transit schedules.
            </p>
          </section>
          ...
          <section className="bg-surface border border-borderDark rounded-2xl p-5 sm:p-7 shadow-lg space-y-3">
            ...
            <p>
              All video content, audio, channel trademarks, and logos displayed on BangkokCams remain the intellectual property of their original YouTube/Kick creators and municipal authorities.
            </p>
            <p>
            ...
            <div className="p-3.5 rounded-xl bg-canvas border border-borderDark font-mono text-xs flex items-center justify-between">
              <div>
                ...
                <span className="text-brandPink font-bold">contact@bangkokcams.com</span>
              </div>
            </div>
          </section>
        </div>
        ...
        <div className="mt-12 pt-6 border-t border-borderDark flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-slate-500">
          <p>© {new Date().getFullYear()} BangkokCams.com. All rights reserved.</p>
