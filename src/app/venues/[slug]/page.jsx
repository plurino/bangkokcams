...
export async function generateMetadata({ params }) {
  ...
  if (!venue) {
    return {
      title: 'Venue Not Found | BangkokCams.com',
    };
  }
  ...
  return {
    title: `${venue.name} Live Stream & Photos | BangkokCams.com`,
    description: `Watch live stream, photos, and exact Google Maps location for ${venue.name} in Bangkok, Thailand. ${venue.description}`,
    openGraph: {
      title: `${venue.name} Live Stream & Photos | BangkokCams.com`,
      description: `Live street webcam, photos, and entertainment guide for ${venue.name}, Bangkok.`,
      url: `https://bangkokcams.com/venues/${venue.slug}/`,
      type: 'video.other',
    },
  };
}
...
export default async function VenuePage({ params }) {
  ...
  const jsonLd = {
    ...
    '@graph': [
      {
        '@type': 'BarOrPub',
        '@id': `https://bangkokcams.com/venues/${venue.slug}/#business`,
        name: venue.name,
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 3,
            name: venue.name,
            item: `https://bangkokcams.com/venues/${venue.slug}/`,
          },
        ],
      },
    ],
