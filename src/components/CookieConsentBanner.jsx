...
export default function CookieConsentBanner() {
  ...
  useEffect(() => {
    try {
      const consent = localStorage.getItem('bangkokcams_cookie_consent');
      if (!consent) {
  ...
  const handleAccept = () => {
    try {
      localStorage.setItem('bangkokcams_cookie_consent', 'accepted');
    } catch (e) {}
    setIsVisible(false);
  };
  ...
  const handleDecline = () => {
    try {
      localStorage.setItem('bangkokcams_cookie_consent', 'declined');
    } catch (e) {}
    setIsVisible(false);
  };
