...
const POPULAR_FEATURED_IDS = [
  '7oQETDBk_s8', // Bangkok Nightlife 4K Walk - Sukhumvit Soi 4 & Nana Plaza
  'cowboy_walk_4k', // Soi Cowboy & Asok Neon 4K Night Walk
  'levels_soi11', // Sukhumvit Soi 11 Walking Tour & Clubs
];

// Filter out live streams, scheduled waiting rooms, and 24/7 webcams from VOD feed
const LIVE_ONLY_CHANNELS = ['bangkok-live', 'bangkok-cams'];
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3">
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-lg md:text-xl font-black tracking-tight text-white flex items-center gap-1.5">
                Bangkok<span className="text-brandPink">Vids</span>
              </h1>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Link
              ...
              title="Explore Bangkok Content Creators & Live Venues"
            >
