...
export default function Navbar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('bangkokcams_trip_updated', calculateDays);
    return () => window.removeEventListener('bangkokcams_trip_updated', calculateDays);
  }, []);
  ...
  return (
    <header className="h-14 border-b border-borderDark bg-surface/95 backdrop-blur-md flex items-center justify-between px-2.5 sm:px-4 md:px-5 shrink-0 z-50 select-none shadow-lg">
      ...
      <div className="flex items-center gap-2 sm:gap-3 shrink-0">
        <Link href="/" className="flex items-center gap-1.5 group shrink-0" title="BangkokCams - Live Street Webcams & Transit Radar">
          <img
            src="/images/logo-dark.png"
            alt="BangkokCams Logo"
      ...
      <div className="flex items-center gap-1 sm:gap-2 shrink-0">
        ...
        >
          {tripDays !== null ? (
            <>
              ...
              <span className="hidden lg:inline text-slate-400">to Bangkok</span>
            </>
          ) : (
            <>
        ...
        <div className="flex items-center bg-canvas/90 p-0.5 rounded-xl border border-borderDark/90 shadow-inner">
          ...
          <Link
            ...
            title="Bangkok Creators & Live Venues Directory"
          >
