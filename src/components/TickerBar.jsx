    ...
    <div className="h-8 bg-surface/95 border-b border-borderDark/70 backdrop-blur-md flex items-center justify-between px-3 sm:px-6 text-[11px] font-mono select-none z-40 w-full max-w-full overflow-x-auto scrollbar-none shadow-inner text-slate-300 gap-2">
      ...
      <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
        ...
        <button
          ...
          title="Bangkok Local Time (ICT / UTC+7) • Click for 7-Day Forecast"
        >
        ...
        {weather ? (
          <button
            ...
            title="Click for 7-Day Bangkok Forecast & Live Windy Satellite Map"
          >
      ...
      <div className="flex items-center gap-1 sm:gap-1.5 shrink-0">
        ...
        <button
          ...
          title="Chao Phraya Express & Saen Saep Canal Boats"
        >
          <Ship className="w-2.5 h-2.5 text-blue-400 shrink-0" />
          <span className="hidden xl:inline">River</span>
          <span>Boats</span>
        </button>
        ...
        <button
          ...
          title="Upcoming Bangkok Events, Festivals & Holidays"
        >
        ...
        <button
          ...
          title="Join Bangkok Pulse VIP Dispatch (Weekly Live Cam & Nightlife Alerts)"
        >
