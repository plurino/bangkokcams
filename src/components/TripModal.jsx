...
export default function TripModal({ isOpen, onClose }) {
  ...
  const handleSave = (e) => {
    ...
    window.dispatchEvent(new Event('bangkokcams_trip_updated'));
  };
      ...
      <div className="relative w-full max-w-lg bg-surface border border-borderDark rounded-2xl p-5 sm:p-6 shadow-2xl z-10 flex flex-col gap-4 animate-scale-up">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="text-base font-bold text-white">
                Bangkok Trip Countdown & Booking
              </h2>
              <p className="text-xs text-slate-400">
                Plan your arrival to Bangkok (Suvarnabhumi BKK & Don Mueang DMK)
              </p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSave} className="flex flex-col gap-3 p-4 bg-surfaceLight/50 rounded-xl border border-borderDark">
          <label className="text-xs font-semibold text-slate-200 flex items-center gap-1.5">
            ...
            <span>Enter Your Bangkok Arrival Date:</span>
          </label>
          <div className="flex items-center gap-2">
            <input
              type="date"
          ...
          <div className="space-y-2.5">
            ...
            <div className="p-3 rounded-xl bg-surfaceLight/40 border border-borderDark flex items-center justify-between gap-3 hover:border-slate-500 transition-colors">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="text-xs font-semibold text-white">Find Flights to Bangkok (BKK/DMK)</span>
            ...
            <div className="p-3 rounded-xl bg-surfaceLight/40 border border-borderDark flex items-center justify-between gap-3 hover:border-slate-500 transition-colors">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="text-xs font-semibold text-white">Private Airport Taxi to Bangkok Hotel</span>
                  <span className="text-[10px] text-slate-400">Fixed rate sedan door-to-door from BKK or DMK</span>
                </div>
              </div>
              <a
