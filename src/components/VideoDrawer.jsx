...
export default function VideoDrawer({ entity, onClose }) {
  ...
  const handleLaunchCityPortal = (code) => {
    ...
    if (typeof window !== 'undefined') {
      window.open('https://cpudapp.bangkok.go.th/bmatraffic/', '_blank', 'noopener,noreferrer');
    }
  };
  ...
  const renderVideoStage = () => {
    ...
    return (
      <YouTubePlayer
        ...
        title={entity.name}
        handle={entity.youtube_handle || entity.handle || '@BangkokWalker'}
        type={entity.type}
        ...
        <div className="p-3.5 rounded-xl bg-emerald-950/20 border border-emerald-500/30 flex flex-col gap-2.5 shadow-md">
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-mono text-slate-300 font-bold flex items-center gap-1.5">
              ...
              <span>24/7 Bangkok Street & Nightlife Webcam</span>
            </span>
          ...
          <p className="text-[11px] text-slate-300 leading-relaxed">
            Continuous real-time exterior live broadcast of Bangkok street, nightlife, and pedestrian traffic. High-definition feed hosted directly on YouTube by {entity.youtube_handle || '@BangkokCams'}.
          </p>
        </div>
      )}
        ...
        <div className="p-3.5 rounded-xl bg-cyan-950/20 border border-brandCyan/30 flex flex-col gap-3 shadow-md">
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-mono text-slate-300 font-bold flex items-center gap-1.5">
              ...
              <span>Bangkok BMA Traffic CCTV Network</span>
            </span>
          ...
          <p className="text-[11px] text-slate-300 leading-relaxed">
            Bangkok Metropolitan Administration (BMA) operates municipal traffic surveillance cameras for public safety and flow monitoring. Live video is accessible via the official BMA Traffic portal.
          </p>
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              ...
              <span>
                {copiedCode
                  ? '✓ Code Copied! Opening BMA Traffic Stream...'
                  : 'Launch Official BMA Traffic Portal'}
              </span>
        ...
        <div className="p-3.5 rounded-xl bg-purple-950/20 border border-purple-500/30 flex flex-col gap-2.5 shadow-md">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[9px] font-mono text-purple-300 bg-purple-900/40 px-2 py-0.5 rounded border border-purple-500/30">
              Mobile Broadcast • Live in Bangkok
            </span>
          </div>
          <p className="text-xs text-slate-300 leading-relaxed">
            This creator broadcasts live walks and nightlife events throughout Bangkok. Because they are on the move across nightlife zones, they do not have a static venue location.
          </p>
