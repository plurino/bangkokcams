...
export default function WeatherModal({ isOpen, onClose, currentWeather }) {
  ...
  useEffect(() => {
    ...
    async function fetchForecast() {
      ...
      try {
        const url =
          'https://api.open-meteo.com/v1/forecast?latitude=13.7469&longitude=100.5349&hourly=temperature_2m,relative_humidity_2m,weather_code,precipitation_probability,wind_speed_10m&daily=weather_code,temperature_2m_max,temperature_2m_min,precipitation_probability_max,wind_speed_10m_max&timezone=Asia%2FBangkok';
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-sm sm:text-base font-bold text-white flex items-center gap-2">
                <span>Bangkok 24-Hour & 7-Day Weather Radar</span>
                <span className="px-2 py-0.5 rounded bg-amber-950/60 border border-amber-500/40 text-amber-400 text-[10px] font-mono flex items-center gap-1">
                  <MapPin className="w-2.5 h-2.5" /> 13.75°N, 100.53°E
                </span>
              </h2>
              <p className="text-[11px] text-slate-400 font-mono">
                Real-time Bangkok & Chao Phraya Basin meteorological telemetry & Open-Meteo ECMWF model
              </p>
            </div>
          </div>
          <button
          ...
          <div className="flex items-center justify-between px-4 py-2.5 bg-canvas/60 border-b border-borderDark text-xs font-mono">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-[10px] text-slate-400">Bangkok Metropolitan Area</span>
              </div>
            </div>
          ...
          {activeTab === 'hourly' && hourlyForecast && (
            <div className="space-y-4">
              <div className="flex items-center justify-between text-slate-400 text-[11px]">
                <span className="font-semibold text-white">Next 24 Hours in Bangkok</span>
            ...
            <div className="space-y-4">
              ...
              <div className="p-3 rounded-xl bg-canvas/70 border border-borderDark text-[11px] text-slate-300 space-y-1.5">
                <div className="flex items-center gap-1.5 text-white font-bold">
                  ...
                  <span>Bangkok Tropical Megacity Climate Guide</span>
                </div>
                <p className="text-slate-400 leading-relaxed">
                  Bangkok features a tropical savanna climate with three primary seasons: Cool & Dry (November to February), Hot & Humid (March to May), and the Southwest Monsoon rainy season (June to October). Afternoon convective tropical showers are common during the monsoon, often bringing spectacular lightning displays over the skyscraper skyline.
                </p>
              </div>
            </div>
          )}
          ...
          {activeTab === 'radar' && (
            <div className="space-y-3">
              <div className="rounded-xl overflow-hidden border border-borderDark bg-canvas shadow-inner">
                <iframe
                  title="Bangkok Live Windy Weather & Wind Radar"
                  width="100%"
                  height="360"
                  src="https://embed.windy.com/embed.html?type=map&location=coordinates&metricRain=default&metricTemp=default&radarRange=-1&algo=baseline&zoom=10&lat=13.7469&lon=100.5349"
                  frameBorder="0"
              ...
              <div className="flex items-center justify-between text-[10px] text-slate-400">
                ...
                <a
                  href="https://www.windy.com/?13.747,100.535,10"
                  target="_blank"
