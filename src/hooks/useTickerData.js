...
const WEATHER_CACHE_KEY = 'bangkokcams_weather_cache';
const WEATHER_CACHE_TTL = 15 * 60 * 1000; // 15 minutes

const FX_CACHE_KEY = 'bangkokcams_fx_cache';
    ...
    async function fetchWeather() {
      ...
      try {
        const res = await fetch(
          'https://api.open-meteo.com/v1/forecast?latitude=13.7469&longitude=100.5349&current=temperature_2m,relative_humidity_2m,weather_code,precipitation,wind_speed_10m&timezone=Asia%2FBangkok'
        );
        if (!res.ok) return;
